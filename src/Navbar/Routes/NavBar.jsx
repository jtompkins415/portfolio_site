    ...
    return (
            ...
            <div className='navbar-container'>
                ...
                <div className='navlink-container-social'>
                  ...
                  ><img className='nav-social-img' src='/assets/github-mark/github-mark.png' alt='github-logo' width={45}/></Link>
                  <Link 
                  href='https://www.linkedin.com/in/jtompkins415/' 
                  className='nav-link-social'
                  underline='none'
                  ><img className='nav-social-img' src='/assets/Black-linkedin-logo-design-on-transparent-background-PNG.png'  style={{ filter: 'hue-rotate(270deg)' }}/></Link>
                </div>
